        ...
        LazyColumn(
            ...
            item {
                ...
                Row(modifier = Modifier
                    ...
                    Row(
                        ...
                        Column {
                            Text(text = "Ganti Kota", fontWeight = FontWeight.Medium, fontSize = 18.sp, color = Color.Black)
                        }
                    }
            ...
            item {
                ...
                Column(modifier = Modifier
                    .fillMaxWidth()
                    .padding(horizontal = 16.dp)) {
                    Text(text = "Kota saat ini", fontWeight = FontWeight.Medium, fontSize = 18.sp, color = Color.Black)
                    Spacer(modifier = Modifier.height(16.dp))
                    Text(text = "Malang", fontSize = 18.sp, color = Color.Black)
                    Spacer(modifier = Modifier.height(8.dp))
                    HorizontalDivider()
                    Spacer(modifier = Modifier.height(24.dp))
                    OutlinedTextField(value = "", onValueChange = {}, modifier = Modifier.fillMaxWidth().height(48.dp))
