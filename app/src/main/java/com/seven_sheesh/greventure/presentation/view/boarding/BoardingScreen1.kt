...
fun BoardingScreen1(
    ...
    LaunchedEffect(Unit) {
        ...
        parentNavController.navigate(ParentNavObj.BoardingScreen2.route)
    }
    ...
    Scaffold(
        ...
        Column(
            ...
            Image(painter = painterResource(id = R.drawable.boarding_1), contentDescription = "Icon", modifier = Modifier.size(260.dp))
            Spacer(modifier = Modifier.height(32.dp))
            Text(text = "Selamat Datang", color = GreventureScheme.Black.color, fontSize = 24.sp, fontWeight = FontWeight.SemiBold)
            Spacer(modifier = Modifier.height(12.dp))
            Text(text = "Mulai petualanganmu bersama\nGreventure!", color = GreventureScheme.Black.color, textAlign = TextAlign.Center, fontSize = 16.sp)
