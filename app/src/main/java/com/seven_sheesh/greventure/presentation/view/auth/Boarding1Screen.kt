...
import com.seven_sheesh.greventure.presentation.ui.widget.BulletProgressIndicator
import com.seven_sheesh.greventure.utils.loadProgress

@Composable
fun Boarding1Screen(authNavCtr: NavController) {
    val currentProgress = remember { mutableFloatStateOf(0f) }
    LaunchedEffect(Unit) {
        loadProgress {
            currentProgress.value = it
        }
        authNavCtr.navigate(AuthNavObj.Boarding2.route)
    }
    ...
    Scaffold(
        ...
        bottomBar = {
            Box(
                ...
                LinearProgressIndicator(
                    ...
                    trackColor = GreventureScheme.SoftGray.color,
        ...
        Column(
            ...
            Image(
                painter = painterResource(id = R.drawable.boarding_1),
            ...
            Text(
                text = "Mulai petualanganmu bersama\nGreventure!",
                color = GreventureScheme.Black.color,
